...
def Run(br: BaseRobot):
    ...
    br.driveArcDist(mm(35.5), mm(26))
    br.waitForMillis(80)
    br.driveForDistance(mm(7), speedPct=45)
    br.waitForMillis(30)
    br.turnInPlace(221)
    br.waitForMillis(30)
    br.driveForDistance(mm(5), speedPct=37)
    ...
    br.turnInPlace(37.5)
    br.waitForMillis(43)
    br.driveForDistance(mm(7.4), speedPct=40)
    br.waitForMillis(40)
    br.driveForDistance(mm(-7.4), speedPct=-40)
    br.turnInPlace(64)
    ...
    br.waitForMillis(50)
    br.driveForDistance(mm(9.5), speedPct=20)
    br.waitForMillis(60)
